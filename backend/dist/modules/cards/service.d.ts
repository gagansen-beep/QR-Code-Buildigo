...
export declare class CardService {
    ...
    static adminGetAll(email: string, password: string, page?: number, limit?: number): Promise<{
        data: QrCard[];
        total: number;
        page: number;
        limit: number;
    ...
    static adminUpdate(email: string, password: string, id: string, input: {
        name?: string;
        designation?: string;
        phone?: string;
        website?: string;
        location?: string;
    }, newImageUrl?: string): Promise<QrCard>;
    /** Admin — delete any card */
    static adminDelete(email: string, password: string, id: string): Promise<void>;
}
